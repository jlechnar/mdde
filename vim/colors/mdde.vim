let g:colors_name = "mdde"

hi mddeArtefact      term=underline  cterm=bold   ctermfg=red     guifg=#ffffff
hi mddeIssue         term=underline  cterm=bold   ctermfg=blue    guifg=#ffffff
hi mddeBug           term=underline  cterm=bold   ctermfg=magenta guifg=#ffffff
