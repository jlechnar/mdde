...
# test 1
We see in {artefact:1} that we do not need to fix {artefact:2} nor {artefact:3}.
But we also see that {artefact:4} is a duplicate of {artefact:1}.
So we can close {artefact:1} or {artefact:4} and update references in 
{artefact:2} and {artefact:3} accordingly.
Link count more than one digit:
 {artefact:3}
 {artefact:3}
 {artefact:3}
 {artefact:3}
